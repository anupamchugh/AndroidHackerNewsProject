...
public class CommentIdObjectRealmProxy extends com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject
    ...
    private ProxyState<com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject>(this);
    ...
    @SuppressWarnings("cast")
    public static com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject obj = realm.createObjectInternal(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class, true, excludeFields);
    ...
    public static com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject obj = new com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject();
        reader.beginObject();
    ...
    public static com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject copyOrUpdate(Realm realm, com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject copy(Realm realm, com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject realmObject = realm.createObjectInternal(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class);
        long tableNativePtr = table.getNativePtr();
        CommentIdObjectColumnInfo columnInfo = (CommentIdObjectColumnInfo) realm.schema.getColumnInfo(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        CommentIdObjectColumnInfo columnInfo = (CommentIdObjectColumnInfo) realm.schema.getColumnInfo(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class);
        com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject object = null;
        while (objects.hasNext()) {
            object = (com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject.class);
    ...
    public static com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject createDetachedCopy(com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject)cachedObject.object;
            } else {
                unmanagedObject = (com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.anupamchugh.androidhackernewsproject.realmPOJO.CommentIdObject();
